...
BIN_OTHER_FILES		+= bin-loong64-efi-sb/ipxe.efi
BIN_OTHER_FILES		+= bin-loong64-efi-sb/snponly.efi
BIN_OTHER_FILES		+= bin-loong64-efi-sb/testsign.crt
...
BIN_OTHER_FILES		+= bin-riscv64-efi-sb/ipxe.efi
BIN_OTHER_FILES		+= bin-riscv64-efi-sb/snponly.efi
BIN_OTHER_FILES		+= bin-riscv64-efi-sb/testsign.crt
